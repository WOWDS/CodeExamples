...
define("WORDING_EDIT_ADMIN_HEADER", "Amend Admin Account");
define("WORDING_REG_ADMIN_HEADER", "Create An Admin Account");
define("WORDING_LOG_ADMIN_HEADER", "Log Into Your Account");
define("WORDING_PASS_RESET_HEADER", "Reset Your Password");
define("WORDING_PASS_REQUEST_HEADER", "Request A Password Reset");
...
define("MESSAGE_DESKTOP_CHANGE_FAILED", "Sorry, your desktop change failed.");
define("MESSAGE_DESKTOP_CHANGED_SUCCESSFULLY", "Your desktop preference has been changed successfully.");
...
define("MESSAGE_USERNAME_BAD_LENGTH", "Username cannot be shorter than 6 or longer than 64 characters");
...
define("MESSAGE_USERNAME_INVALID", "Username does not fit the name scheme: only a-Z and numbers are allowed, 6 to 64 characters");
define("MESSAGE_USERNAME_SAME_LIKE_OLD_ONE", "Sorry, that username is the same as your current one. Please choose another one.");

// views
define("WORDING_BACK_TO_DASHBOARD", "Back to the Dashboard");
...
define("WORDING_CHANGE_DESKTOP", "Change desktop");
...
define("WORDING_NEW_DESKTOP_PRO", "Products");
define("WORDING_NEW_DESKTOP_CLT", "Clients");
define("WORDING_NEW_EMAIL", "Edit Email");
define("WORDING_NEW_PASSWORD", "New Password");
define("WORDING_NEW_PASSWORD_REPEAT", "Repeat New Password");
define("WORDING_NEW_USERNAME", "Edit Username");
...
define("WORDING_REGISTRATION_CAPTCHA", "Please enter the characters above");
define("WORDING_REGISTRATION_EMAIL", "Please provide a real email address, you'll get a verification mail with an activation link");
define("WORDING_REGISTRATION_PASSWORD", "Minimum of 6 characters!");
define("WORDING_REGISTRATION_PASSWORD_REPEAT", "Ensure both passwords match");
define("WORDING_REGISTRATION_USERNAME", "Only letters and numbers, 6 to 64 characters");
define("WORDING_REMEMBER_ME", "Keep me logged in for 2 weeks");
define("WORDING_REQUEST_PASSWORD_RESET", "Enter your username");
define("WORDING_REQUEST_PASSWORD_RESET_TIP", "Enter your username and you'll get an email with instructions.");
...
define("WORDING_USERNAME_TIP", "Username");
